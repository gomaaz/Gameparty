...
(function () {
    ...
    function renderPlayerChip(playerName) {
        ...
        const icons = [
            ...
            info.steam ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.steam}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.527s-2.03 4.525-4.524 4.525h-.105l-4.076 2.911c0 .052.004.105.004.159 0 1.875-1.515 3.396-3.39 3.396-1.635 0-3.016-1.173-3.331-2.727L.436 15.27C1.862 20.307 6.486 24 11.979 24c6.627 0 11.999-5.373 11.999-12S18.605 0 11.979 0zM7.54 18.21l-1.473-.61c.262.543.714.999 1.314 1.25 1.297.539 2.793-.076 3.332-1.375.263-.63.264-1.319.005-1.949s-.75-1.121-1.377-1.383c-.624-.26-1.29-.249-1.878-.03l1.523.63c.956.4 1.409 1.5 1.009 2.455-.397.957-1.497 1.41-2.454 1.012H7.54zm11.415-9.303c0-1.662-1.353-3.015-3.015-3.015-1.665 0-3.015 1.353-3.015 3.015 0 1.665 1.35 3.015 3.015 3.015 1.663 0 3.015-1.35 3.015-3.015zm-5.273-.005c0-1.252 1.013-2.266 2.265-2.266 1.249 0 2.266 1.014 2.266 2.266 0 1.251-1.017 2.265-2.266 2.265-1.252 0-2.265-1.014-2.265-2.265z"/></svg></span>` : '',
            info.ubisoft ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.ubisoft}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M23.561 11.988C23.301-.304 6.954-4.89.656 6.634c.282.206.661.477.943.672a11.747 11.747 0 00-.976 3.067 11.885 11.885 0 00-.184 2.071C.439 18.818 5.621 24 12.005 24c6.385 0 11.556-5.17 11.556-11.556v-.455zm-20.27 2.06c-.152 1.246-.054 1.636-.054 1.788l-.282.098c-.108-.206-.37-.932-.488-1.908C2.163 10.308 4.7 6.96 8.57 6.33c3.544-.52 6.937 1.68 7.728 4.758l-.282.098c-.087-.087-.228-.336-.77-.878-4.281-4.281-11.002-2.32-11.956 3.74zm11.002 2.081a3.145 3.145 0 01-2.59 1.355 3.15 3.15 0 01-3.155-3.155 3.159 3.159 0 012.927-3.144c1.018-.043 1.972.51 2.416 1.398a2.58 2.58 0 01-.455 2.95c.293.205.575.4.856.595zm6.58.12c-1.669 3.782-5.106 5.766-8.77 5.712-7.034-.347-9.083-8.466-4.38-11.393l.207.206c-.076.108-.358.325-.791 1.182-.51 1.041-.672 2.081-.607 2.732.369 5.67 8.314 6.83 11.045 1.214C21.057 8.217 11.822.401 3.626 6.374l-.184-.184C5.599 2.808 9.816 1.3 13.837 2.309c6.147 1.55 9.453 7.956 7.035 13.94z"/></svg></span>` : '',
            info.battlenet ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.battlenet}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M7.839 2.738c.097.235.189.474.273.717a16.37 16.37 0 0 1 .84 5.594c-.016 1.703-.29 3.37-.79 4.948l-.074.222-.008.024c-.303.885-.67 1.738-1.095 2.544a10.4 10.4 0 0 1-.483.82 10.547 10.547 0 0 1-1.158 1.48c-.195.203-.397.398-.607.582.025-.065.05-.13.076-.195.232-.585.43-1.187.594-1.8a14.614 14.614 0 0 0 .427-3.598c0-1.39-.176-2.733-.506-4.01a15.14 15.14 0 0 0-.527-1.65c-.097-.252-.2-.502-.31-.748C3.9 5.97 2.717 4.468 1.25 3.39c.258-.093.521-.175.789-.245A9.015 9.015 0 0 1 4.406 2.9c1.14 0 2.24.208 3.258.585l.175.065zm9.908-.405c-.208.093-.41.194-.607.302a9.947 9.947 0 0 0-1.72 1.222 11.31 11.31 0 0 0-2.265 3.037 13.15 13.15 0 0 0-1.215 4.02 14.013 14.013 0 0 0-.084 2.46c.06 1.102.26 2.171.585 3.183.258.8.594 1.567 1.001 2.287.16.285.33.563.51.833a9.022 9.022 0 0 1-2.854.463 9.025 9.025 0 0 1-4.553-1.23 9.018 9.018 0 0 1-3.284-3.339 9.028 9.028 0 0 1-1.217-4.574c0-2.41.946-4.598 2.487-6.218.195-.203.397-.399.607-.583A9.018 9.018 0 0 1 9.5 2.238c2.388 0 4.566.93 6.167 2.445.237.225.46.46.672.703a8.94 8.94 0 0 1 1.408 2.21z"/></svg></span>` : '',
            info.epic ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.epic}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M3.537 0C2.165 0 1.66.506 1.66 1.879V18.44c0 1.372.505 1.878 1.877 1.878h4.585v2.769h-5.88C.877 23.087 0 22.206 0 20.209V1.879C0 .884.877 0 1.879 0h16.958v2.77H3.537zm11.27 5.384v12.705h8.46V5.384h-8.46zm5.658 2.769v7.166h-2.854V8.153h2.854z"/></svg></span>` : '',
            info.ea ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.ea}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M0 12C0 5.373 5.373 0 12 0c6.628 0 12 5.373 12 12 0 6.628-5.372 12-12 12C5.373 24 0 18.628 0 12zm12.317-5.766L6.34 17.766h3.31l1.002-2.316h4.636l.987 2.316h3.384L13.66 6.234h-1.343zm-.658 2.854 1.5 3.605h-3.04l1.54-3.605z"/></svg></span>` : '',
            info.riot ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.riot}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M12.438.008 0 2.19v16.806l2.876.504V5.043l1.932.338v14.946l2.876.504v-15.1l1.795.31V21.1L12.425 24 24 21.814V18.9L9.479 21.44V4.647L24 7.203V4.29Z"/></svg></span>` : '',
            info.discord ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.discord}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg></span>` : '',
            info.teamspeak ? `<span class="icon-copy" style="cursor:pointer" data-copy-value="${info.teamspeak}"><svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M12.005.605h-.09l-.028.001h-.064a11.374 11.374 0 0 0-11.24 11.39c0 4.303 2.262 8.07 5.657 10.226v2.574c0 .756.753.773 1.206.403l2.961-2.438a11.412 11.412 0 0 0 2.495.27h.064l.028-.001h.09a11.375 11.375 0 0 0 11.24-11.39A11.375 11.375 0 0 0 12.005.605zm0 2.034c5.081 0 9.217 4.122 9.217 9.356S17.086 21.35 12.005 21.35c-.747 0-1.473-.08-2.181-.237l-2.15 1.77v-1.806c-2.879-1.923-4.786-5.153-4.786-8.727 0-5.234 4.136-9.356 9.217-9.356zm0 1.518a3.904 3.904 0 0 0-3.886 3.922c0 2.163 1.748 3.921 3.886 3.921 2.138 0 3.887-1.758 3.887-3.921 0-2.163-1.749-3.922-3.887-3.922zm-3.886 6.944a1.959 1.959 0 1 0 3.917 0 1.959 1.959 0 0 0-3.917 0zm3.886-1.958a1.959 1.959 0 1 0-3.917 0 1.959 1.959 0 0 0 3.917 0zm3.886-1.959a1.959 1.959 0 1 0 0-3.917 1.959 1.959 0 0 0 0 3.917z"/></svg></span>` : '',
        ].filter(Boolean).join('');
    ...
    function renderLeaderIcons(leaderName) {
        ...
        if (info.steam)    icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Steam<br>${info.steam}" data-copy-value="${info.steam}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.527s-2.03 4.525-4.524 4.525h-.105l-4.076 2.911c0 .052.004.105.004.159 0 1.875-1.515 3.396-3.39 3.396-1.635 0-3.016-1.173-3.331-2.727L.436 15.27C1.862 20.307 6.486 24 11.979 24c6.627 0 11.999-5.373 11.999-12S18.605 0 11.979 0zM7.54 18.21l-1.473-.61c.262.543.714.999 1.314 1.25 1.297.539 2.793-.076 3.332-1.375.263-.63.264-1.319.005-1.949s-.75-1.121-1.377-1.383c-.624-.26-1.29-.249-1.878-.03l1.523.63c.956.4 1.409 1.5 1.009 2.455-.397.957-1.497 1.41-2.454 1.012H7.54zm11.415-9.303c0-1.662-1.353-3.015-3.015-3.015-1.665 0-3.015 1.353-3.015 3.015 0 1.665 1.35 3.015 3.015 3.015 1.663 0 3.015-1.35 3.015-3.015zm-5.273-.005c0-1.252 1.013-2.266 2.265-2.266 1.249 0 2.266 1.014 2.266 2.266 0 1.251-1.017 2.265-2.266 2.265-1.252 0-2.265-1.014-2.265-2.265z"/></svg></span>`);
        if (info.ubisoft)  icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Ubisoft Connect<br>${info.ubisoft}" data-copy-value="${info.ubisoft}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M23.561 11.988C23.301-.304 6.954-4.89.656 6.634c.282.206.661.477.943.672a11.747 11.747 0 00-.976 3.067 11.885 11.885 0 00-.184 2.071C.439 18.818 5.621 24 12.005 24c6.385 0 11.556-5.17 11.556-11.556v-.455zm-20.27 2.06c-.152 1.246-.054 1.636-.054 1.788l-.282.098c-.108-.206-.37-.932-.488-1.908C2.163 10.308 4.7 6.96 8.57 6.33c3.544-.52 6.937 1.68 7.728 4.758l-.282.098c-.087-.087-.228-.336-.77-.878-4.281-4.281-11.002-2.32-11.956 3.74zm11.002 2.081a3.145 3.145 0 01-2.59 1.355 3.15 3.15 0 01-3.155-3.155 3.159 3.159 0 012.927-3.144c1.018-.043 1.972.51 2.416 1.398a2.58 2.58 0 01-.455 2.95c.293.205.575.4.856.595zm6.58.12c-1.669 3.782-5.106 5.766-8.77 5.712-7.034-.347-9.083-8.466-4.38-11.393l.207.206c-.076.108-.358.325-.791 1.182-.51 1.041-.672 2.081-.607 2.732.369 5.67 8.314 6.83 11.045 1.214C21.057 8.217 11.822.401 3.626 6.374l-.184-.184C5.599 2.808 9.816 1.3 13.837 2.309c6.147 1.55 9.453 7.956 7.035 13.94z"/></svg></span>`);
        if (info.battlenet)icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Battle.net<br>${info.battlenet}" data-copy-value="${info.battlenet}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M7.839 2.738c.097.235.189.474.273.717a16.37 16.37 0 0 1 .84 5.594c-.016 1.703-.29 3.37-.79 4.948l-.074.222-.008.024c-.303.885-.67 1.738-1.095 2.544a10.4 10.4 0 0 1-.483.82 10.547 10.547 0 0 1-1.158 1.48c-.195.203-.397.398-.607.582.025-.065.05-.13.076-.195.232-.585.43-1.187.594-1.8a14.614 14.614 0 0 0 .427-3.598c0-1.39-.176-2.733-.506-4.01a15.14 15.14 0 0 0-.527-1.65c-.097-.252-.2-.502-.31-.748C3.9 5.97 2.717 4.468 1.25 3.39c.258-.093.521-.175.789-.245A9.015 9.015 0 0 1 4.406 2.9c1.14 0 2.24.208 3.258.585l.175.065zm9.908-.405c-.208.093-.41.194-.607.302a9.947 9.947 0 0 0-1.72 1.222 11.31 11.31 0 0 0-2.265 3.037 13.15 13.15 0 0 0-1.215 4.02 14.013 14.013 0 0 0-.084 2.46c.06 1.102.26 2.171.585 3.183.258.8.594 1.567 1.001 2.287.16.285.33.563.51.833a9.022 9.022 0 0 1-2.854.463 9.025 9.025 0 0 1-4.553-1.23 9.018 9.018 0 0 1-3.284-3.339 9.028 9.028 0 0 1-1.217-4.574c0-2.41.946-4.598 2.487-6.218.195-.203.397-.399.607-.583A9.018 9.018 0 0 1 9.5 2.238c2.388 0 4.566.93 6.167 2.445.237.225.46.46.672.703a8.94 8.94 0 0 1 1.408 2.21z"/></svg></span>`);
        if (info.epic)     icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Epic Games<br>${info.epic}" data-copy-value="${info.epic}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M3.537 0C2.165 0 1.66.506 1.66 1.879V18.44c0 1.372.505 1.878 1.877 1.878h4.585v2.769h-5.88C.877 23.087 0 22.206 0 20.209V1.879C0 .884.877 0 1.879 0h16.958v2.77H3.537zm11.27 5.384v12.705h8.46V5.384h-8.46zm5.658 2.769v7.166h-2.854V8.153h2.854z"/></svg></span>`);
        if (info.ea)       icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="EA App<br>${info.ea}" data-copy-value="${info.ea}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M0 12C0 5.373 5.373 0 12 0c6.628 0 12 5.373 12 12 0 6.628-5.372 12-12 12C5.373 24 0 18.628 0 12zm12.317-5.766L6.34 17.766h3.31l1.002-2.316h4.636l.987 2.316h3.384L13.66 6.234h-1.343zm-.658 2.854 1.5 3.605h-3.04l1.54-3.605z"/></svg></span>`);
        if (info.riot)     icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Riot Games<br>${info.riot}" data-copy-value="${info.riot}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M12.438.008 0 2.19v16.806l2.876.504V5.043l1.932.338v14.946l2.876.504v-15.1l1.795.31V21.1L12.425 24 24 21.814V18.9L9.479 21.44V4.647L24 7.203V4.29Z"/></svg></span>`);
        if (info.discord)  icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="Discord<br>${info.discord}" data-copy-value="${info.discord}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg></span>`);
        if (info.teamspeak) icons.push(`<span class="leader-info-icon player-chip-info icon-copy" style="cursor:pointer" data-tooltip="TeamSpeak<br>${info.teamspeak}" data-copy-value="${info.teamspeak}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M12.005.605h-.09l-.028.001h-.064a11.374 11.374 0 0 0-11.24 11.39c0 4.303 2.262 8.07 5.657 10.226v2.574c0 .756.753.773 1.206.403l2.961-2.438a11.412 11.412 0 0 0 2.495.27h.064l.028-.001h.09a11.375 11.375 0 0 0 11.24-11.39A11.375 11.375 0 0 0 12.005.605zm0 2.034c5.081 0 9.217 4.122 9.217 9.356S17.086 21.35 12.005 21.35c-.747 0-1.473-.08-2.181-.237l-2.15 1.77v-1.806c-2.879-1.923-4.786-5.153-4.786-8.727 0-5.234 4.136-9.356 9.217-9.356zm0 1.518a3.904 3.904 0 0 0-3.886 3.922c0 2.163 1.748 3.921 3.886 3.921 2.138 0 3.887-1.758 3.887-3.921 0-2.163-1.749-3.922-3.887-3.922zm-3.886 6.944a1.959 1.959 0 1 0 3.917 0 1.959 1.959 0 0 0-3.917 0zm3.886-1.958a1.959 1.959 0 1 0-3.917 0 1.959 1.959 0 0 0 3.917 0zm3.886-1.959a1.959 1.959 0 1 0 0-3.917 1.959 1.959 0 0 0 0 3.917z"/></svg></span>`);
            ...
            container.innerHTML = `
                ...
                <div class="card">
                    ...
                    <div class="accounts-grid">
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.527s-2.03 4.525-4.524 4.525h-.105l-4.076 2.911c0 .052.004.105.004.159 0 1.875-1.515 3.396-3.39 3.396-1.635 0-3.016-1.173-3.331-2.727L.436 15.27C1.862 20.307 6.486 24 11.979 24c6.627 0 11.999-5.373 11.999-12S18.605 0 11.979 0zM7.54 18.21l-1.473-.61c.262.543.714.999 1.314 1.25 1.297.539 2.793-.076 3.332-1.375.263-.63.264-1.319.005-1.949s-.75-1.121-1.377-1.383c-.624-.26-1.29-.249-1.878-.03l1.523.63c.956.4 1.409 1.5 1.009 2.455-.397.957-1.497 1.41-2.454 1.012H7.54zm11.415-9.303c0-1.662-1.353-3.015-3.015-3.015-1.665 0-3.015 1.353-3.015 3.015 0 1.665 1.35 3.015 3.015 3.015 1.663 0 3.015-1.35 3.015-3.015zm-5.273-.005c0-1.252 1.013-2.266 2.265-2.266 1.249 0 2.266 1.014 2.266 2.266 0 1.251-1.017 2.265-2.266 2.265-1.252 0-2.265-1.014-2.265-2.265z"/></svg> ${t('profile_steam')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M23.561 11.988C23.301-.304 6.954-4.89.656 6.634c.282.206.661.477.943.672a11.747 11.747 0 00-.976 3.067 11.885 11.885 0 00-.184 2.071C.439 18.818 5.621 24 12.005 24c6.385 0 11.556-5.17 11.556-11.556v-.455zm-20.27 2.06c-.152 1.246-.054 1.636-.054 1.788l-.282.098c-.108-.206-.37-.932-.488-1.908C2.163 10.308 4.7 6.96 8.57 6.33c3.544-.52 6.937 1.68 7.728 4.758l-.282.098c-.087-.087-.228-.336-.77-.878-4.281-4.281-11.002-2.32-11.956 3.74zm11.002 2.081a3.145 3.145 0 01-2.59 1.355 3.15 3.15 0 01-3.155-3.155 3.159 3.159 0 012.927-3.144c1.018-.043 1.972.51 2.416 1.398a2.58 2.58 0 01-.455 2.95c.293.205.575.4.856.595zm6.58.12c-1.669 3.782-5.106 5.766-8.77 5.712-7.034-.347-9.083-8.466-4.38-11.393l.207.206c-.076.108-.358.325-.791 1.182-.51 1.041-.672 2.081-.607 2.732.369 5.67 8.314 6.83 11.045 1.214C21.057 8.217 11.822.401 3.626 6.374l-.184-.184C5.599 2.808 9.816 1.3 13.837 2.309c6.147 1.55 9.453 7.956 7.035 13.94z"/></svg> ${t('profile_ubisoft')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M7.839 2.738c.097.235.189.474.273.717a16.37 16.37 0 0 1 .84 5.594c-.016 1.703-.29 3.37-.79 4.948l-.074.222-.008.024c-.303.885-.67 1.738-1.095 2.544a10.4 10.4 0 0 1-.483.82 10.547 10.547 0 0 1-1.158 1.48c-.195.203-.397.398-.607.582.025-.065.05-.13.076-.195.232-.585.43-1.187.594-1.8a14.614 14.614 0 0 0 .427-3.598c0-1.39-.176-2.733-.506-4.01a15.14 15.14 0 0 0-.527-1.65c-.097-.252-.2-.502-.31-.748C3.9 5.97 2.717 4.468 1.25 3.39c.258-.093.521-.175.789-.245A9.015 9.015 0 0 1 4.406 2.9c1.14 0 2.24.208 3.258.585l.175.065zm9.908-.405c-.208.093-.41.194-.607.302a9.947 9.947 0 0 0-1.72 1.222 11.31 11.31 0 0 0-2.265 3.037 13.15 13.15 0 0 0-1.215 4.02 14.013 14.013 0 0 0-.084 2.46c.06 1.102.26 2.171.585 3.183.258.8.594 1.567 1.001 2.287.16.285.33.563.51.833a9.022 9.022 0 0 1-2.854.463 9.025 9.025 0 0 1-4.553-1.23 9.018 9.018 0 0 1-3.284-3.339 9.028 9.028 0 0 1-1.217-4.574c0-2.41.946-4.598 2.487-6.218.195-.203.397-.399.607-.583A9.018 9.018 0 0 1 9.5 2.238c2.388 0 4.566.93 6.167 2.445.237.225.46.46.672.703a8.94 8.94 0 0 1 1.408 2.21z"/></svg> ${t('profile_battlenet')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M3.537 0C2.165 0 1.66.506 1.66 1.879V18.44c0 1.372.505 1.878 1.877 1.878h4.585v2.769h-5.88C.877 23.087 0 22.206 0 20.209V1.879C0 .884.877 0 1.879 0h16.958v2.77H3.537zm11.27 5.384v12.705h8.46V5.384h-8.46zm5.658 2.769v7.166h-2.854V8.153h2.854z"/></svg> ${t('profile_epic')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M0 12C0 5.373 5.373 0 12 0c6.628 0 12 5.373 12 12 0 6.628-5.372 12-12 12C5.373 24 0 18.628 0 12zm12.317-5.766L6.34 17.766h3.31l1.002-2.316h4.636l.987 2.316h3.384L13.66 6.234h-1.343zm-.658 2.854 1.5 3.605h-3.04l1.54-3.605z"/></svg> ${t('profile_ea')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M12.438.008 0 2.19v16.806l2.876.504V5.043l1.932.338v14.946l2.876.504v-15.1l1.795.31V21.1L12.425 24 24 21.814V18.9L9.479 21.44V4.647L24 7.203V4.29Z"/></svg> ${t('profile_riot')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z"/></svg> ${t('profile_discord')}</label>
                        ...
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M12.005.605h-.09l-.028.001h-.064a11.374 11.374 0 0 0-11.24 11.39c0 4.303 2.262 8.07 5.657 10.226v2.574c0 .756.753.773 1.206.403l2.961-2.438a11.412 11.412 0 0 0 2.495.27h.064l.028-.001h.09a11.375 11.375 0 0 0 11.24-11.39A11.375 11.375 0 0 0 12.005.605zm0 2.034c5.081 0 9.217 4.122 9.217 9.356S17.086 21.35 12.005 21.35c-.747 0-1.473-.08-2.181-.237l-2.15 1.77v-1.806c-2.879-1.923-4.786-5.153-4.786-8.727 0-5.234 4.136-9.356 9.217-9.356zm0 1.518a3.904 3.904 0 0 0-3.886 3.922c0 2.163 1.748 3.921 3.886 3.921 2.138 0 3.887-1.758 3.887-3.921 0-2.163-1.749-3.922-3.887-3.922zm-3.886 6.944a1.959 1.959 0 1 0 3.917 0 1.959 1.959 0 0 0-3.917 0zm3.886-1.958a1.959 1.959 0 1 0-3.917 0 1.959 1.959 0 0 0 3.917 0zm3.886-1.959a1.959 1.959 0 1 0 0-3.917 1.959 1.959 0 0 0 0 3.917z"/></svg> ${t('profile_teamspeak')}</label>
