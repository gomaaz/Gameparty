...
(function () {
    ...
    function renderPlayerChip(playerName) {
        ...
        const hasData = info.ip || info.steam || info.ubisoft || info.battlenet || info.epic || info.ea || info.riot || info.discord;
        const icons = [
            info.ip ? '🖥️' : '',
            ...
            info.epic ? '<svg style="width:12px;height:12px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M17.757 0H6.243A6.243 6.243 0 0 0 0 6.243v11.514A6.243 6.243 0 0 0 6.243 24h11.514A6.243 6.243 0 0 0 24 17.757V6.243A6.243 6.243 0 0 0 17.757 0zM7.8 16.8V7.2h8.4v2.4H10.2v1.8h5.4v2.4H10.2V16.8Z"/></svg>' : '',
    ...
    function renderLeaderIcons(leaderName) {
        ...
        if (info.ubisoft)  icons.push(`<span class="leader-info-icon player-chip-info" data-tooltip="Ubisoft Connect<br>${info.ubisoft}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 3.103c1.426 0 2.586 1.161 2.586 2.587S13.426 8.277 12 8.277 9.414 7.116 9.414 5.69 10.574 3.103 12 3.103zm6.62 3.448c.47 0 .85.38.85.851 0 .47-.38.85-.85.85-.47 0-.851-.38-.851-.85 0-.471.38-.851.85-.851zm-13.24 0c.47 0 .85.38.85.851 0 .47-.38.85-.85.85-.47 0-.851-.38-.851-.85 0-.471.38-.851.85-.851zM12 9.931c3.348 0 6.069 2.72 6.069 6.069S15.348 22.07 12 22.07c-3.349 0-6.069-2.721-6.069-6.07S8.65 9.932 12 9.932zm0 1.724c-2.398 0-4.345 1.947-4.345 4.345S9.602 20.345 12 20.345s4.345-1.947 4.345-4.345S14.398 11.655 12 11.655z"/></svg></span>`);
        ...
        if (info.epic)     icons.push(`<span class="leader-info-icon player-chip-info" data-tooltip="Epic Games<br>${info.epic}"><svg style="width:16px;height:16px;vertical-align:middle;fill:currentColor" viewBox="0 0 24 24"><path d="M17.757 0H6.243A6.243 6.243 0 0 0 0 6.243v11.514A6.243 6.243 0 0 0 6.243 24h11.514A6.243 6.243 0 0 0 24 17.757V6.243A6.243 6.243 0 0 0 17.757 0zM7.8 16.8V7.2h8.4v2.4H10.2v1.8h5.4v2.4H10.2V16.8Z"/></svg></span>`);
    ...
    async function renderProfile() {
        ...
        try {
            ...
            container.innerHTML = `
                ...
                <div class="card">
                    ...
                    <div class="accounts-grid">
                        ...
                        <input type="text" id="profile-ubisoft-input" class="accounts-input" placeholder="${t('profile_accounts_placeholder_ubisoft')}" value="${(currentUser && currentUser.ubisoft) || ''}">
                        <label class="accounts-label"><svg style="width:14px;height:14px;vertical-align:middle;fill:#c6d4df" viewBox="0 0 24 24"><path d="M17.757 0H6.243A6.243 6.243 0 0 0 0 6.243v11.514A6.243 6.243 0 0 0 6.243 24h11.514A6.243 6.243 0 0 0 24 17.757V6.243A6.243 6.243 0 0 0 17.757 0zM7.8 16.8V7.2h8.4v2.4H10.2v1.8h5.4v2.4H10.2V16.8Z"/></svg> ${t('profile_epic')}</label>
            ...
            // Save Accounts (IP + Steam + Ubisoft + Battle.net + Epic + EA + Riot + Discord)
                ...
                saveAccountsBtn.addEventListener('click', async () => {
                    ...
                    try {
                        await Promise.all([
                            ...
                            api('PUT', `/users/${encodeURIComponent(player)}/accounts`, { steam, ubisoft, battlenet, epic, ea, riot, discord }),
                        ]);
                        // Update state.allUsers lokal
                        const idx = state.allUsers.findIndex(u => u.name === player);
                        if (idx >= 0) Object.assign(state.allUsers[idx], { ip, steam, ubisoft, battlenet, epic, ea, riot, discord });
