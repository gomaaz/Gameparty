...
const TRANSLATIONS = {
    en: {
        ...
        help_leaderboard_body: 'Gameparty tracks two things: <b>Coins</b> and <b>Siegpunkte</b> (Victory Points).<br><br>Siegpunkte are worth more than coins and carry more weight on the leaderboard. The more Siegpunkte you have, the higher you climb. Earn coins through sessions — buy Siegpunkte in the Shop or wager and win them in Challenges.',
        ...
        help_stars_title: 'Siegpunkte (Victory Points)',
        help_stars_body: 'Siegpunkte are worth more than regular Coins and have a bigger impact on your leaderboard rank.<br><br>You can <b>buy</b> Siegpunkte in the Shop. You can also <b>wager</b> them in Challenges — put your Siegpunkte on the line and win more from your opponent, or lose them if you fall short.',
        help_challenges_title: '⚔️ Challenges',
        help_challenges_body: '<b>1v1 Duel:</b> Challenge another present player. Both sides accept, then play the match and report the result.<br><br><b>Team Challenge:</b> Form two teams and compete. The winning team earns Siegpunkte.',
    ...
    de: {
        ...
        help_leaderboard_body: 'Gameparty verfolgt zwei Dinge: <b>Coins</b> und <b>Siegpunkte</b>.<br><br>Siegpunkte sind mehr wert als Coins und haben mehr Gewicht im Leaderboard. Je mehr Siegpunkte du hast, desto höher steigst du auf. Coins verdienst du durch Sessions – Siegpunkte kannst du im Shop kaufen oder in Challenges einsetzen und dazugewinnen.',
        ...
        help_stars_title: 'Siegpunkte',
        help_stars_body: 'Siegpunkte sind mehr wert als normale Coins und haben einen größeren Einfluss auf deinen Rang im Leaderboard.<br><br>Du kannst Siegpunkte im <b>Shop kaufen</b>. Außerdem kannst du sie in Challenges <b>einsetzen</b> – setze deine Siegpunkte aufs Spiel und gewinne welche vom Gegner, oder verliere sie, wenn du unterlegst.',
        help_challenges_title: '⚔️ Challenges',
        help_challenges_body: '<b>1v1 Duell:</b> Fordere einen anwesenden Spieler heraus. Beide nehmen an, spielen die Partie und melden das Ergebnis.<br><br><b>Team-Challenge:</b> Bilde zwei Teams und tretet gegeneinander an. Das Siegerteam erhält Siegpunkte.',
        help_sessions_title: '🎮 Sessions',
